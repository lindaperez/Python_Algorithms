...
assert (obj2.get(7)==-1)
res=obj2.get(5)
assert (res==5)     #returns 5 is it updated
print("Should be 5",res)
assert (obj2.get(8)==-1)
...
print("Should be -1",res)
assert (res==-1)
res=obj2.get(5)        # returns -1 because the cache reached it's capacity
print("Should be -1",res)
